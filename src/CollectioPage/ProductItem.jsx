      ...
      <div className=" group ">
        <Link to={`/product/${id}`}>
          <div className="relative  group  cursor-pointer overflow-hidden">
            <img src={image} alt="Product" className="w-full hover:scale-115 transition-all duration-400 " />
            ...
            <div className="absolute bottom-0 w-full opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
              <h1 className="flex cursor-pointer justify-center items-center gap-2 bg-orange-400 text-white p-2">
                Add to Cart <IoBag />
              </h1>
            </div>
          </div>
